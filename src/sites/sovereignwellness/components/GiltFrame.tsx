...
export function GiltFrame({ src, alt, name, title }: GiltFrameProps) {
  return (
    <div className="flex flex-col">
      <div className="w-full p-2 bg-gradient-to-br from-[#B08C3A] to-[#8A6B2A] shadow-lg">
      ...
      <div className="mt-4 mx-auto bg-[#4A3A1A] text-[#F5ECD7] px-5 py-2 text-center border border-[#B08C3A]">
