...
const FINGER_RISK_TAX_RATE = 0.078
      ...
      <section className="py-20 px-4 text-center">
        <div className="max-w-lg mx-auto">
          ...
          <p className="text-foreground/60 mb-8">
            Your trap is tragically unsprung.
          </p>
          <Link
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-8 border-t border-primary/10 pt-8">
          <div className="max-w-xs ml-auto space-y-2">
            ...
            <div className="flex justify-between text-foreground/70">
              <span>Dangerous Goods Handling Fee</span>
              <span>${HANDLING_FEE.toFixed(2)}</span>
            </div>
            <div className="flex justify-between text-foreground/70">
              <span>Finger Risk Tax (7.8%)</span>
              <span>${fingerRiskTax.toFixed(2)}</span>
            </div>
