export const metadata = {
  title: "Terms of Use — Boneless Water",
  description: "The terms governing your use of the Boneless Water bone-free water platform.",
}
      ...
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="mt-6 border-l-4 border-[#0c4a6e] bg-[#0c4a6e]/5 p-5 rounded-r-lg">
          ...
          <p className="text-sm text-[#0f172a]/80">
            The authoritative terms of use for all Specific Industries properties — including Boneless Water — are maintained at{" "}
        ...
        <p className="mt-2 text-[#0f172a]/80">
          By purchasing any Boneless Water product, you agree to consume it as drinking water. You may not use any of our products for hydraulic system testing, irrigation, swimming pool top-off, pet baths, or any application other than direct human and certified-pet hydration.
        </p>

        <h2 className="mt-6 text-xl font-bold text-[#dc2626]">2. Health Claims</h2>
        <p className="mt-2 text-[#0f172a]/80">
          Boneless Water does not diagnose, treat, cure, or prevent any disease. The connection between aqueous bone fragments and indigestion is widely understood within our research community but has not been formally endorsed by the relevant federal agencies, for reasons we have documented elsewhere on this site.
        </p>
        ...
        <p className="mt-2 text-[#0f172a]/80">
          Boneless Water is not affiliated with Murklake® Reservoir Water and has never been. Any subscriber who confuses our product with theirs should immediately contact Director of Consumer Protection Russell Coleman.
        </p>
