...
export const metadata: PageMetadata = {
  title: "Trust & Safety — Super Engineered",
  description: "How Super Engineered stewards the telemetry generated by your essential objects.",
}
      ...
      <section className="py-20 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6 text-primary/80 leading-relaxed">
            <p>
              Telemetry from your Super Engineered devices is ingested through regional edge pops and consolidated into two geo-redundant data planes in the United States and the European Union.
            </p>
            <p>
